...
## [v1.0.0-a3](https://github.com/espressif/iperf-cmd/releases/tag/v1.0.0-a3)
...
- add test logs for iperf stop ([ba9fd026](https://github.com/espressif/iperf-cmd/commit/ba9fd026))
...
- update dependencies [espressif/iperf](https://components.espressif.com/components/espressif/iperf) to v1.0.0-a3
